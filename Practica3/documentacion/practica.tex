...
\begin{table}[H]
	\begin{center}
		\scalebox{0.8}{%
		\begin{tabularx}{1.2\textwidth}{|c|c|c|c|c|c|c|c|}
			\hline
			\textbf{Mejora} & 
				\textbf{$X_{i}^{(1)}(40)$} & 
				\textbf{$s_{i}^{2}(40)$} &\textbf{$N_{i}$} &
				\textbf{$X_{i}^{(2)}\left(N_{i}-40\right)$} & \textbf{$W_{i 1}$} &\textbf{$W_{i 2}$} &\textbf{$X_{i}^{p}\left(N_{i}\right)$}\\
			\hline \hline
			\textbf{tormenta}&1.0049&0.0038&41&0.9529&1.4851&-0.4851&1.0302\\ \hline
			\textbf{velocidad}&1.2461&0.0139&41&1.2316&1.2080&-0.2080&1.2491\\ \hline
			\textbf{4atraques}&0.0867&$6.588*10^{-6}$&41&0.0856&13.7886&-12.7886&0.1017\\ \hline	
			\textbf{5atraques}&0.0470&$3.803*10^{-7}$&41&0.0472&54.3109&-53.3109&0.04069\\ \hline
		\end{tabularx}
		}
